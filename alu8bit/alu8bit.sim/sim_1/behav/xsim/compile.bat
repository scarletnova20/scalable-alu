...
REM
REM Generated by Vivado on Tue Sep 09 20:20:49 +0530 2025
...
echo "xvlog --incr --relax -prj alu8bit_vlog.prj"
call xvlog  --incr --relax -prj alu8bit_vlog.prj -log xvlog.log
