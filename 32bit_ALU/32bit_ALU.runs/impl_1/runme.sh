...
HD_PWD='C:/Users/hridd/32bit_ALU/32bit_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_32bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_32bit.tcl -notrace
