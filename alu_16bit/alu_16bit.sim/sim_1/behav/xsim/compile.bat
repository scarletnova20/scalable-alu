...
REM
REM Generated by Vivado on Tue Oct 14 22:31:48 +0530 2025
...
echo "xvlog --incr --relax -prj tb_16bitalu_vlog.prj"
call xvlog  --incr --relax -prj tb_16bitalu_vlog.prj -log xvlog.log
